...
async function getSEOArticles() {
  try {
    ...
    // Filter for SEO articles
    const seoArticles = data.posts?.filter((article: any) => 
      article.meta?.category === 'SEO' || 
        ...
        <section className="py-16 bg-gradient-to-br from-background to-muted/20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold text-balance">SEO новини и стратегии</h1>

              <p className="text-xl text-muted-foreground text-pretty max-w-2xl mx-auto">
                Научи най-новите SEO техники, следи алгоритмичните промени на Google и подобри позициите на своя сайт в
                търсачките.
              </p>
